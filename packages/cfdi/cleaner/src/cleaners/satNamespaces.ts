/**
 * Namespaces oficiales del SAT que NO deben eliminarse.
 * Incluye todos los complementos fiscales publicados en el Anexo 20.
 */
export const SAT_NAMESPACES: ReadonlySet<string> = new Set([
